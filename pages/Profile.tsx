...
import { ArrowLeft, Save, User as UserIcon, Mail, Shield, Bell, Moon, LogOut } from 'lucide-react';
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="px-6 pb-6 text-center">
                ...
                <h2 className="text-xl font-bold text-slate-900">{state.user.name}</h2>
                <p className="text-sm text-slate-500">{state.user.email}</p>
                <div className="mt-4 flex items-center justify-center gap-2">
                   <span className="px-2 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full">Pro Member</span>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              <h3 className="text-sm font-semibold text-slate-900 mb-4">Activity Stats</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <form onSubmit={handleSave}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        disabled
                        className="block w-full pl-10 pr-3 py-2 border border-slate-200 rounded-md bg-slate-50 text-slate-500 sm:text-sm cursor-not-allowed"
                      />
                    </div>
                ...
                <div className="mt-6 flex items-center justify-between">
                   {successMessage && (
                     <span className="text-sm text-emerald-600 font-medium animate-in fade-in slide-in-from-left-2">
                       {successMessage}
                     </span>
                   )}
