    ...
    >
      ...
      <div className="flex-grow min-w-0 z-10">
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          <h4
            className={`text-base font-semibold text-slate-800 dark:text-white truncate transition-all ${isCompleted ? 'line-through text-slate-500 dark:text-slate-400' : ''
              }`}
          >
            {task.title}
          </h4>
